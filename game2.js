...
const fistImageArray = ['./assets/images/0.jpg', './assets/images/1.jpg', './assets/images/2.jpg', './assets/images/3.jpg', './assets/images/4.jpg', './assets/images/5.jpg'];
...
fistDisplay.src = './assets/images/5.jpg';
// -----------------------------------------------------------------------------------
...
const gameObject = {
    ...
    endGame: function (currentResult) {
        ...
        if (currentResult === true) {
            ...
            console.log('lost');
            fistDisplay.src = './assets/images/lost.jpg'
        }
    },
    ...
    displayFistState: function (num) {
        // switch (num) {
        //     case '0':
        //         fistDisplay.src = './assets/images/0.jpg';
        //         break;
        //     case '1':
        //         fistDisplay.src = './assets/images/1.jpg';
        //         break;
        //     case '2':
        //         fistDisplay.src = './assets/images/2.jpg';
        //         break;
        //     case '3':
        //         fistDisplay.src = './assets/images/3.jpg';
        //         break;
        //     case '4':
        //         fistDisplay.src = './assets/images/4.jpg';
        //         break;
        //     case '5':
        //         fistDisplay.src = './assets/images/5.jpg';
        //         break;
        ...
        if (num === 0) { fistDisplay.src = './assets/images/lost.jpg' };
        if (num === 1) { fistDisplay.src = './assets/images/1.jpg' };
        if (num === 2) { fistDisplay.src = './assets/images/2.jpg' };
        if (num === 3) { fistDisplay.src = './assets/images/3.jpg' };
        if (num === 4) { fistDisplay.src = './assets/images/4.jpg' };
        if (num === 5) { fistDisplay.src = './assets/images/5.jpg' };
    },
